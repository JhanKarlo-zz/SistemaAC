...
namespace SistemaAC.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var ID = "";
            //Declaroun objeto list que depente de la clase Usuario
            List<Usuario> usuario = new List<Usuario>();
            //Ahora obtengo todos los registros de la tabla donde alamaceno los usuarios
        ...
        {
            //Declaro un objeto que depende de la clase usuario
            List<Usuario> usuario = new List<Usuario>();
        ...
        public async Task<String> DeleteUsuario(string id)
        {
            ...
            {
                var appUsuario = await _context.ApplicationUser.SingleOrDefaultAsync(m => m.Id == id);
                _context.ApplicationUser.Remove(appUsuario);
                await _context.SaveChangesAsync();
                resp = "Delete";
            }
            catch (Exception ex)
